...
export function FooterFeatures() {
  ...
  return (
    <>
      ...
      <section className="block md:hidden bg-[#FCFBF8] py-8 px-4">
        <div className="flex flex-col gap-3.5">
          {/* Feature 1 */}
          <div className="bg-[#F7F6F2] rounded-[24px] p-5 border border-gray-200/60 flex items-center gap-4 shadow-2xs">
            <div className="w-12 h-12 rounded-full bg-[#E5ECE5] flex items-center justify-center text-[#1E4631] shrink-0 shadow-2xs">
              <Truck className="w-6 h-6 stroke-[1.8]" />
            </div>
            <div>
              <h4 className="font-serif font-bold text-[16px] text-[#1E4631] leading-tight mb-0.5">Free Shipping</h4>
              <p className="text-gray-500 text-[12px]">On orders over ₹999</p>
            </div>
          </div>
          ...
          <div className="bg-[#F7F6F2] rounded-[24px] p-5 border border-gray-200/60 flex items-center gap-4 shadow-2xs">
            ...
            <div>
              <h4 className="font-serif font-bold text-[16px] text-[#1E4631] leading-tight mb-0.5">24/7 Support</h4>
              <p className="text-gray-500 text-[12px]">Expert plant care advice</p>
            </div>
          </div>
          ...
          <div className="bg-[#F7F6F2] rounded-[24px] p-5 border border-gray-200/60 flex items-center gap-4 shadow-2xs">
            ...
            <div>
              <h4 className="font-serif font-bold text-[16px] text-[#1E4631] leading-tight mb-0.5">Guarantee</h4>
              <p className="text-gray-500 text-[12px]">30-day money back</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ─── DESKTOP VIEW ─── */}
      <section className="hidden md:block py-20 bg-white border-t border-[#f0f0f0]" ref={ref}>
