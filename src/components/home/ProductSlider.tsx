...
export function ProductSlider({ title = "Products", categoryFilter, saleOnly }: ProductSliderProps) {
    ...
    <section className="py-12 bg-white overflow-hidden" ref={ref}>
      <div className="container mx-auto px-6 lg:px-12 max-w-[1440px]">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }}
          className="mb-8 border-b border-gray-200 flex items-end justify-between pb-4">
          <h2 className="font-serif text-[32px] text-[#1a1a1a] font-medium leading-none">{title}</h2>
