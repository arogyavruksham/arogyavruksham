      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <select
            ...
            className="px-4 py-2 bg-white border border-black/5 rounded-xl text-sm font-semibold text-gray-700 shadow-2xs outline-none"
          >
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-white border border-black/5 rounded-xl text-xs font-black uppercase tracking-wider text-gray-700 shadow-2xs">
            ...
            <tbody className="text-sm divide-y divide-gray-100 font-medium">
              {loading ? (
                ...
                filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-[#FCFCFD]/80 transition-colors">
                    <td className="p-4 pl-6">
                      <input type="checkbox" className="rounded border-gray-300 text-gray-900 focus:ring-black cursor-pointer" />
                    </td>
                    <td className="p-4">
                      <div className="flex items-center gap-3.5">
                        <div className="w-10 h-10 rounded-xl bg-gray-100 text-gray-900 border border-black/5 flex items-center justify-center font-black text-sm shrink-0 shadow-2xs">
                    ...
                    <td className="p-4">
                      <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold capitalize border ${
                        ...
                        'bg-[#FCFCFD] text-gray-600 border-black/5'
                      }`}>
                    ...
                    <td className="p-4 pr-6 text-right">
                      {updatingId === user.id ? (
                        ...
                        <select 
                          ...
                          className="bg-white border border-black/5 text-gray-900 text-xs font-bold rounded-xl focus:ring-1 focus:ring-black focus:border-black py-1.5 px-3 outline-none shadow-2xs cursor-pointer ml-auto transition-all hover:border-black"
                        >
                          <option value="user">User</option>
                          <option value="editor">Editor</option>
                          <option value="manager">Manager</option>
