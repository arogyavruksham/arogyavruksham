...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 max-w-full font-sans text-[#4A3B32] pb-24">
      
      {/* Header & Global Filter */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-5 border-b border-[#EBE3D5] pb-8">
        <div>
          <h1 className="text-2xl md:text-2xl font-black tracking-tighter text-[#4A3B32]">Dashboard</h1>
          <p className="text-sm md:text-base text-[#96887E] mt-2 max-w-[65ch]">
        ...
        <select 
          ...
          className="bg-[#FCF8F5] border border-[#EBE3D5] text-[#4A3B32] text-sm font-bold rounded-2xl px-3 py-2 outline-none hover:bg-[#C25934]/5 transition-colors cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Total Revenue */}
        <div className="bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] flex flex-col justify-between h-48 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3]">Total Revenue</span>
            <div className="w-10 h-10 bg-[#F7F2EC] rounded-xl flex items-center justify-center text-[#C25934] border border-[#EBE3D5] group-hover:scale-110 transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <TrendingUp className="w-5 h-5" strokeWidth={1.5} />
            </div>
          </div>
          <div>
            <p className="text-4xl font-black tracking-tighter text-[#4A3B32] mb-1">₹{metrics.totalSales.toLocaleString('en-IN')}</p>
            <span className="inline-flex items-center text-[10px] font-bold text-[#B8ACA3] tracking-wide uppercase">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] flex flex-col justify-between h-48 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3]">Total Orders</span>
            <div className="w-10 h-10 bg-[#F7F2EC] rounded-xl flex items-center justify-center text-[#C25934] border border-[#EBE3D5] group-hover:scale-110 transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <ShoppingBag className="w-5 h-5" strokeWidth={1.5} />
            </div>
          </div>
          <div>
            <p className="text-4xl font-black tracking-tighter text-[#4A3B32] mb-1">{metrics.totalOrders}</p>
            <span className="inline-flex items-center text-[10px] font-bold text-[#B8ACA3] tracking-wide uppercase">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] flex flex-col justify-between h-48 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3]">Unique Users</span>
            <div className="w-10 h-10 bg-[#F7F2EC] rounded-xl flex items-center justify-center text-[#C25934] border border-[#EBE3D5] group-hover:scale-110 transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <Users className="w-5 h-5" strokeWidth={1.5} />
            </div>
          </div>
          <div>
            <p className="text-4xl font-black tracking-tighter text-[#4A3B32] mb-1">{metrics.totalCustomers}</p>
            <span className="inline-flex items-center text-[10px] font-bold text-[#B8ACA3] tracking-wide uppercase">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] flex flex-col justify-between h-48 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3]">Fulfillment</span>
            <div className="w-10 h-10 bg-[#F7F2EC] rounded-xl flex items-center justify-center text-[#C25934] border border-[#EBE3D5] group-hover:scale-110 transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <Package className="w-5 h-5" strokeWidth={1.5} />
            </div>
          </div>
          <div>
            <p className="text-4xl font-black tracking-tighter text-[#4A3B32] mb-1">{metrics.pendingDelivery}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white p-5 md:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] lg:col-span-2 flex flex-col">
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-2xl font-black tracking-tighter text-[#4A3B32]">Revenue Velocity</h2>
            <select 
              value={salesMonthFilter}
              onChange={(e) => setSalesMonthFilter(e.target.value)}
              className="bg-[#FCF8F5] border border-[#EBE3D5] text-[#4A3B32] font-bold text-sm rounded-xl px-4 py-2 outline-none cursor-pointer hover:bg-[#C25934]/5 transition-colors"
            >
          ...
          <div className="flex flex-wrap gap-6 sm:gap-10 mb-10 pb-8 border-b border-[#EBE3D5]">
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3] mb-2">Total Income</p>
              <div className="flex items-baseline gap-2">
                <p className="text-2xl font-black tracking-tighter text-[#4A3B32]">₹{chartTotals.income.toLocaleString('en-IN')}</p>
              </div>
            </div>
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest text-[#B8ACA3] mb-2">Est. Expenses</p>
              <div className="flex items-baseline gap-2">
                <p className="text-2xl font-black tracking-tighter text-[#B8ACA3]">₹{chartTotals.expenses.toLocaleString('en-IN')}</p>
              </div>
            </div>
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest text-[#4A3B32] mb-2">Net Balance</p>
              <div className="flex items-baseline gap-2">
                <p className="text-2xl font-black tracking-tighter text-[#C25934]">₹{chartTotals.balance.toLocaleString('en-IN')}</p>
              </div>
            </div>
          </div>
        ...
        {/* Sales Target Donut */}
        <div className="bg-white p-5 md:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] flex flex-col">
          <h2 className="text-2xl font-black tracking-tighter text-[#4A3B32] mb-5">Target Quota</h2>
          ...
          <div className="flex-1 flex flex-col justify-center items-center relative">
            ...
            <div className="w-full mt-8 space-y-5 bg-[#FCF8F5] p-6 rounded-2xl border border-[#EBE3D5]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-gray-200"></div>
                  <span className="text-[11px] font-bold uppercase tracking-widest text-[#96887E]">Daily Mark</span>
                </div>
                <div className="font-bold text-[#4A3B32] text-sm">
                  ₹5,000
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#C25934]"></div>
                  <span className="text-[11px] font-bold uppercase tracking-widest text-[#4A3B32]">Monthly</span>
                </div>
                <div className="flex items-center gap-1 font-black text-[#4A3B32] text-base">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white p-5 md:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] lg:col-span-2">
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-2xl font-black tracking-tighter text-[#4A3B32]">Top Performing</h2>
            <div className="flex gap-2">
              <button className="w-10 h-10 rounded-full flex items-center justify-center bg-[#FCF8F5] border border-[#EBE3D5] text-[#B8ACA3] hover:text-[#C25934] transition-colors">&larr;</button>
              <button className="w-10 h-10 rounded-full flex items-center justify-center bg-[#FCF8F5] border border-[#EBE3D5] text-[#B8ACA3] hover:text-[#C25934] transition-colors">&rarr;</button>
            </div>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {topProducts.map((product) => (
              <div key={product.id} className="group flex flex-col p-4 bg-[#FCF8F5] border border-[#EBE3D5] rounded-2xl hover:bg-[#C25934]/5 transition-colors cursor-pointer">
                <div className="bg-white rounded-xl aspect-square mb-4 p-4 flex items-center justify-center overflow-hidden border border-[#EBE3D5] shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                  {product.image_url ? (
                ...
                <h4 className="font-bold text-[#4A3B32] text-sm truncate mb-2">{product.title || product.name}</h4>
                <div className="flex items-center justify-between mt-auto">
                  <span className="text-sm font-black tracking-tight text-[#4A3B32]">₹{product.price}</span>
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#96887E]">{product.sales_count} Sold</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Current Offer */}
        <div className="bg-white p-5 md:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5]">
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-2xl font-black tracking-tighter text-[#4A3B32]">Campaigns</h2>
            <a href="/admin/offers" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#FCF8F5] border border-[#EBE3D5] hover:bg-[#C25934]/5 transition-colors">
              <ChevronRight className="w-5 h-5 text-[#7A6B61]" strokeWidth={1.5} />
            </a>
          </div>

          <div className="space-y-4">
            {activeCoupons.length === 0 ? (
              <p className="text-sm text-[#96887E] italic">No active campaigns.</p>
              ...
              return (
                <div key={coupon.id} className="p-3 bg-[#FCF8F5] rounded-2xl border border-[#EBE3D5]">
                  <div className="flex justify-between items-center text-sm mb-4">
                    <div className="flex items-center gap-3">
                      <span className="font-bold text-[#4A3B32]">{coupon.title}</span>
                      {!isExpired && !isUpcoming && <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>}
                    </div>
                    <span className="text-[#B8ACA3] text-[10px] font-bold uppercase tracking-widest">
                      {new Date(coupon.expiry_date).toLocaleDateString('en-GB', { day: 'numeric', month: 'short' })}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-1 overflow-hidden">
                    <div 
                      className={`h-1 rounded-full ${isUpcoming ? 'bg-gray-400' : (isExpired ? 'bg-gray-300' : 'bg-[#C25934]')}`} 
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#EBE3D5] overflow-hidden">
        <div className="p-5 md:p-10 border-b border-[#EBE3D5] flex justify-between items-center bg-[#FCF8F5]">
          <div>
            <h2 className="text-2xl font-black tracking-tighter text-[#4A3B32]">Recent Transactions</h2>
            <p className="text-sm text-[#96887E] mt-1 font-medium">Live fulfillment feed across all gateways</p>
          </div>
        ...
        <div className="overflow-x-auto p-4 md:p-6">
          <table className="w-full text-left border-collapse min-w-[800px] whitespace-nowrap">
            <thead>
              <tr className="border-b border-[#EBE3D5] text-[10px] uppercase tracking-widest text-[#B8ACA3] font-bold">
            ...
            <tbody className="text-sm">
              {recentOrders.length === 0 ? (
                <tr>
                  <td colSpan={5} className="p-10 text-center text-[#96887E] font-medium">
                ...
                return (
                  <tr key={order.id} className="group hover:bg-[#F7F2EC] transition-colors rounded-2xl">
                    <td className="p-4 pl-6 align-middle rounded-l-2xl">
                      <p className="font-bold text-[#4A3B32]">#{order.id.split('-')[0].toUpperCase()}</p>
                      <p className="text-xs text-[#B8ACA3] mt-1 font-medium">{new Date(order.created_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</p>
                    </td>
                    <td className="p-4 align-middle">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-white border border-[#EBE3D5] flex items-center justify-center font-black text-xs text-[#4A3B32] shadow-[0_2px_8px_rgba(0,0,0,0.02)] shrink-0">
                          {avatarLetter}
                        </div>
                        <div>
                    ...
                    <td className="p-4 align-middle">
                      {order.shipping_address ? (
                        <div className="flex items-center gap-3 w-full min-w-[200px] whitespace-normal">
                          <div className="w-8 h-8 rounded-full bg-white border border-[#EBE3D5] flex items-center justify-center shrink-0">
                            <MapPin className="w-3 h-3 text-[#B8ACA3]" strokeWidth={1.5} />
                          </div>
                          <div>
                            <span className="font-bold text-[#4A3B32] text-sm block">{order.shipping_address.name}</span>
                            <span className="text-xs text-[#96887E] line-clamp-1">
                              {order.shipping_address.city} • {order.shipping_address.phone}
                            </span>
                          </div>
                        </div>
                      ) : (
                        <span className="text-xs text-[#B8ACA3] font-medium">Digital/No Info</span>
                      )}
                    </td>
                    <td className="p-4 align-middle">
                      <span className="font-black tracking-tight text-[#4A3B32] text-base">
                    ...
                    <td className="p-4 pr-6 align-middle rounded-r-2xl text-right">
                      <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest ${
                        order.status === 'delivered' ? 'bg-white border border-[#EBE3D5] text-[#4A3B32]' :
                        order.status === 'cancelled' ? 'bg-[#FCF8F5] text-[#B8ACA3] line-through border border-transparent' :
