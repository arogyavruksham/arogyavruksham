...
export default function CategoriesPage() {
  ...
  return (
    <div className="space-y-6 text-[#111827] font-sans pb-12">
      ...
      {successMsg && (
        <div className="p-4 bg-white border border-[#059669] text-[#111827] rounded-lg shadow-2xs flex items-center gap-3 animate-in fade-in">
          <div className="p-1 bg-[#059669] text-white shadow-sm border-0 hover:bg-[#047857] rounded-full"><Check className="w-3 h-3" /></div>
      ...
      {isAdding && (
        <div className="bg-white p-6 md:p-5 rounded-lg border border-[#E5E7EB] shadow-xl animate-in slide-in-from-top-4">
          ...
          <form onSubmit={handleAddCategory} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-[#D1D5DB] rounded-lg focus:border-[#059669] focus:ring-1 focus:ring-[#059669] outline-none font-bold text-[#111827] text-sm"
                />
              </div>
            ...
            {image && (
              <div className="flex items-center gap-4 p-4 bg-[#F9FAFB] rounded-lg border border-[#E5E7EB]">
                <div className="w-12 h-12 rounded-lg overflow-hidden border border-[#E5E7EB] shadow-2xs">
            ...
            <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
              <button
                ...
                className="px-5 py-2.5 text-xs font-bold text-[#4B5563] hover:bg-[#E5E7EB] rounded-lg transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-6 py-2.5 bg-[#059669] hover:bg-gray-900 text-white font-extrabold text-xs rounded-lg shadow-xs transition-all cursor-pointer"
              >
                Save Category
              </button>
            </div>
                ...
                <tr key={idx} className="hover:bg-[#F9FAFB]/80 transition-colors group">
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3.5">
                      <div className="w-11 h-11 rounded-lg bg-[#F9FAFB] overflow-hidden shrink-0 border border-gray-100 p-0.5 flex items-center justify-center">
                        {cat.image ? (
                  ...
                  <td className="p-4 pr-6 text-right">
                    <button
                      ...
                      className="p-2 text-[#9CA3AF] hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors cursor-pointer"
