...
export default function SignupPage() {
  ...
  // Main Navigation Modes & Toggles (defaults to 'signup' mode matching Image 3)
  ...
  const handleMainSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        setSuccessMsg('Account created successfully! Taking you to sanctuary...')
        setTimeout(() => router.push('/'), 1200)
      } else {
        if (!password) {
    ...
    <div className="min-h-screen bg-[#FAFAF7] flex flex-col justify-between selection:bg-[#235839] selection:text-white">
      ...
      <header className="p-6 sm:px-12 flex items-center justify-between max-w-7xl mx-auto w-full">
        ...
        <div className="w-24 text-right">
          <Link href="/login" className="text-xs font-bold text-[#235839] hover:underline">
            Sign In
          </Link>
        </div>
      </header>
            ...
            <div>
              ...
              <div className="mb-7">
                ...
                <div className="sm:hidden">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Create an account to join the botanical sanctuary.
                  </p>
                </div>
